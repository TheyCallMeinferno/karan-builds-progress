...
const Services = () => {
  ...
  return <section id="services" className="py-20 gradient-subtle">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {services.map((service, index) => <Card key={service.title} className="shadow-elegant hover:shadow-glow transition-all duration-500 transform hover:scale-105 animate-slide-up group cursor-pointer" style={{
          animationDelay: `${index * 0.1}s`
              ...
              <CardContent className="pt-0">
                ...
                <div className="grid grid-cols-2 gap-2 mb-6">
                  {service.features.map((feature, featureIndex) => <div key={feature} className="flex items-center gap-2 text-sm text-muted-foreground" style={{
                ...
                {/* CTA Button */}
                <Button variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300" onClick={scrollToContact}>
                  Get Started
